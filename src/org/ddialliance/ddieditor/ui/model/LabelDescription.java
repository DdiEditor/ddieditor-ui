...
public class LabelDescription extends Model {
	private static Log log = LogFactory.getLog(LogType.SYSTEM, LabelDescription.class);
	...
	public LabelDescription(String id, String version, String parentId, String parentVersion, List<LabelType> labels,
