...
public class CodeScheme extends Model implements IModel {
	 ...
	 * @throws Exception
	 */
	public CodeScheme(CodeSchemeDocument doc, String parentId, String parentVersion) throws Exception {
	...
	public void addCode(int index, String categoryReference, String value) {
		...
		codeType.addNewCategoryReference().addNewID().setStringValue(categoryReference);
	...
	public void executeChange(Object value, Class<?> type) throws Exception {
		...
		if (type.equals(ReferenceType.class)) {
			SchemeReferenceType ref = doc.getCodeScheme().getCategorySchemeReference();
			String id = XmlBeansUtil.getXmlAttributeValue(xml.xmlText(), "id=\"");
			if (ref == null) {
