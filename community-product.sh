...
svn mkdir $svnurl/dda/tags/ddiftp/community-release-$version -m '$memo'

# ddiftp
svn copy $svnurl/dda/trunk/ddiftp $svnurl/dda/tags/ddiftp/community-release-$version/ -m '$memo'
